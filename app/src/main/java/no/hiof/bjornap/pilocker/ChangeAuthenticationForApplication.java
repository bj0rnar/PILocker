 ...
 */
public class ChangeAuthenticationForApplication extends Fragment {
    ...
    public ChangeAuthenticationForApplication() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_change_authentication_for_application, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String oldSelection = EncryptedSharedPref.readString(EncryptedSharedPref.APPLOGINMETHOD, "nothing");
            ...
            public void onClick(View v) {
                switch (selection){
                    case 0:
                        ...
                        navController.navigate(R.id.action_changeAuthenticationForApplication_to_unlockFragment2);
                        break;
                    case 1:
